...
Original dataset has been merged the training and the test sets to create one data set called 'dataset'.

Variable names has been labeled. For variables that have duplicated names that has been added suffix.

'activity' column has been changed to factor and correct names of activity has been assigned as labels. 

In dataset 'subset' extracted only columns on the mean and standard deviation. 

Whole dataset has been grouped by activity and subject and for every variable mean has been calculated.
